...
docker buildx build --tag "ams21/tor-relay:latest" --platform "linux/amd64,linux/arm,linux/arm/v6,linux/arm/v7,linux/arm64,linux/arm64/v8,linux/i386,linux/ppc64le,linux/riscv64" --pull "${SCRIPT_DIR}"
